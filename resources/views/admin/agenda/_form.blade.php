...
<div class="space-y-6">
    <div class="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3">
        <label class="flex items-start gap-3 text-sm text-slate-700">
            ...
            <input type="checkbox" name="is_published" value="1" class="mt-1 h-4 w-4 rounded border-slate-300 text-primary focus:ring-primary/30" @checked(old('is_published', $agenda->is_published ?? false))>
            <span>
