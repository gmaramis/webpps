@php
    /** @var \App\Models\S3Program $program */
...
<div class="space-y-6">
    ...
    <div>
        ...
        <p class="mb-2 text-[11px] text-slate-500">Digunakan di alamat <code class="rounded bg-slate-100 px-1">/s3?program=<strong>slug</strong></code>. Kosongkan untuk dibuat otomatis dari nama Indonesia.</p>
    ...
    <div class="grid gap-4 sm:grid-cols-2">
        <div>
            ...
            <p class="mb-2 text-[11px] text-slate-500">Teks singkat untuk kartu program di beranda (disarankan 1–2 kalimat, maks. 220 karakter). Deskripsi panjang tetap di kolom di bawah untuk halaman <span class="font-mono">/s3</span>.</p>
            <textarea id="excerpt_id" name="excerpt_id" rows="3" maxlength="220"
        ...
        <div>
            ...
            <p class="mb-2 text-[11px] text-slate-500">Versi Inggris untuk beranda (locale EN), maks. 220 karakter.</p>
            <textarea id="excerpt_en" name="excerpt_en" rows="3" maxlength="220"
