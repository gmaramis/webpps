...
<div class="space-y-6">
    ...
    <div class="grid gap-4 sm:grid-cols-2">
        <div>
            ...
            <p class="mb-2 text-[11px] text-slate-500">Teks singkat untuk kartu program di beranda (disarankan 1–2 kalimat, maks. 220 karakter). Deskripsi panjang tetap di kolom di bawah untuk halaman <span class="font-mono">/s2</span>.</p>
