...
@section('title', 'ZI — Tambah galeri')
@section('heading', 'Tambah item galeri')
@section('content')
<div class="w-full min-w-0 space-y-5">
    ...
    <div class="rounded-3xl border border-slate-200/80 bg-white/90 p-6 md:p-8">
        <form method="post" action="{{ route('admin.zi.galeri.store') }}" enctype="multipart/form-data" class="space-y-8">@csrf
