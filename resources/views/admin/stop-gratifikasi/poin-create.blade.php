...
@section('title', 'Tambah poin Stop Gratifikasi')
@section('heading', 'Stop Gratifikasi — tambah poin')
...
<div class="w-full min-w-0 space-y-4">
    ...
    <div class="rounded-2xl border border-slate-200/80 bg-white/90 p-4 shadow-lg ring-1 ring-white/70 md:p-5">
        <form method="post" action="{{ route('admin.stop-gratifikasi.poin.store') }}" class="space-y-4">
            @csrf
