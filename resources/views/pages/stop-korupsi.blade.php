    ...
    <div class="mx-auto max-w-6xl px-4">
        ...
        <section class="mt-10 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            ...
            <div class="mt-6 flex flex-wrap gap-3">
                ...
                <a href="https://spanlapor.kemenpan.go.id/" target="_blank" rel="noopener noreferrer" class="inline-flex rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-white hover:bg-primary-dark">{{ $t['stopLinkSpanLapor'] }}</a>
            </div>
        </section>
    </div>
</main>
