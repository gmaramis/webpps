...
return new class extends Migration
{
    ...
    {
        Schema::create('stop_gratifikasi_page_contents', function (Blueprint $table): void {
            $table->id();
            ...
            $table->string('link_instrumen_zi_url', 2048)->nullable();
            $table->longText('simple_body_id')->nullable();
            $table->longText('simple_body_en')->nullable();
            $table->timestamps();
        });

        Schema::create('stop_gratifikasi_bullets', function (Blueprint $table): void {
            $table->id();
    ...
    {
        Schema::dropIfExists('stop_gratifikasi_bullets');
        Schema::dropIfExists('stop_gratifikasi_page_contents');
    }
};
