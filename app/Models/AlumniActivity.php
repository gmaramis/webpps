...
class AlumniActivity extends Model
{
    ...
    public function resolvedImagePublicPath(): string
    {
        ...
        if (str_starts_with($path, 'alumni-activities/')) {
            return 'storage/'.$path;
        }
    ...
    /**
     * Bentuk seperti ALUMNI_ACTIVITIES di pps-content.json.
     *
    ...
    /**
     * Impor dari key ALUMNI_ACTIVITIES pada resources/data/pps-content.json (mengganti isi tabel).
     *
    ...
    public static function importFromPpsContentJson(): int
    {
        ...
        $rows = $decoded['ALUMNI_ACTIVITIES'] ?? [];
