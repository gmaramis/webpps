...
#[Fillable([
    ...
    'link_span_lapor_label_id',
    'link_span_lapor_label_en',
    'link_span_lapor_url',
    'simple_body_id',
    'simple_body_en',
])]
class StopKorupsiPageContent extends Model
{
    protected $table = 'stop_korupsi_page_contents';
    ...
    /** Teks untuk kolom “isi” di form admin: isi tunggal, atau gabungan lama (lead + paragraf) jika belum diset. */
