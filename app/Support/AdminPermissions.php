...
final class AdminPermissions
{
    ...
    public static function all(): array
    {
        return [
            ...
            'director-greeting.manage',
            'beranda-sejarah.manage',
            'pengumuman.manage',
            'agenda.manage',
            'visi-misi.manage',
    ...
    public static function labels(): array
    {
        return [
            ...
            'director-greeting.manage' => 'Kelola sambutan direktur di beranda',
            'beranda-sejarah.manage' => 'Kelola blok sejarah Pascasarjana di beranda',
