...
class S3ProgramRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => [
                ...
                'max:255',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('s3_programs', 'slug')->ignore($program?->getKey()),
            ],
            'name_id' => ['required', 'string', 'max:255'],
            'name_en' => ['nullable', 'string', 'max:255'],
            'blurb_id' => ['required', 'string', 'max:5000'],
            'blurb_en' => ['nullable', 'string', 'max:5000'],
            'excerpt_id' => ['nullable', 'string', 'max:220'],
            'excerpt_en' => ['nullable', 'string', 'max:220'],
